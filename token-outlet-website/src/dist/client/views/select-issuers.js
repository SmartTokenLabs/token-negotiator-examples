...
var SelectIssuers = (function (_super) {
    ...
    SelectIssuers.prototype.issuerConnectMarkup = function (title, image, issuer) {
        return "\n            <li class=\"issuer-connect-banner-tn\" data-issuer=\"".concat(issuer, "\" role=\"menuitem\">\n              <div style=\"display: flex; align-items: center;\">\n                <div class=\"img-container-tn issuer-icon-tn shimmer-tn\" data-image-src=\"").concat(image, "\" data-token-title=\"").concat(title, "\"></div>\n                <p class=\"issuer-connect-title\">").concat(title, "</p>\n              </div>\n              <button aria-label=\"connect with the token issuer ").concat(issuer, "\" aria-haspopup=\"true\" aria-expanded=\"false\" aria-controls=\"token-list-container-tn\" class=\"connect-btn-tn\" data-issuer=\"").concat(issuer, "\">Load</button>\n              <button aria-label=\"tokens available from token issuer ").concat(issuer, "\" aria-haspopup=\"true\" aria-expanded=\"false\" aria-controls=\"token-list-container-tn\" class=\"tokens-btn-tn\" data-issuer=\"").concat(issuer, "\">Tokens Available</button>\n            </li>\n        ");
    };
    ...
    SelectIssuers.prototype.issuerConnected = function (issuer, tokens) {
        ...
        tokenBtn.innerHTML = "".concat(tokens.length, " token/s available");
    ...
    SelectIssuers.prototype.updateTokensView = function (issuer) {
        ...
        tokenData[location][issuer].tokens.map(function (t, i) {
            ...
            if (location === "offChainTokens") {
                ...
                var tokenId = (_b = t.tokenId) !== null && _b !== void 0 ? _b : i.toString();
                tokens.push({
                    data: t,
                    tokenIssuerKey: issuer,
                    index: tokenId,
