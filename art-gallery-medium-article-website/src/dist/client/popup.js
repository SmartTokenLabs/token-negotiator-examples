...
var Popup = (function () {
    ...
    Popup.prototype.openOverlay = function () {
    ...
    Popup.prototype.updatePopup = function (ViewClass, data) {
    ...
    Popup.prototype.showError = function () {
        var message = [];
    ...
    Popup.prototype.dismissLoader = function () {
        this.loadContainer.style.display = 'none';
    };
    Popup.prototype.addTheme = function () {
        var _a, _b;
        var refTokenSelector = document.querySelector(".overlay-tn");
        if (refTokenSelector)
            refTokenSelector.classList.add(((_b = (_a = this.options) === null || _a === void 0 ? void 0 : _a.theme) !== null && _b !== void 0 ? _b : 'light'));
    };
    Popup.prototype.assignFabButtonAnimation = function () {
