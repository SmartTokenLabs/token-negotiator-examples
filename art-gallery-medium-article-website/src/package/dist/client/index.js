...
var Client = (function () {
    ...
    Client.prototype.readProofCallback = function () {
        ...
        var attest = params.get("attestation");
    ...
    Client.prototype.setPassiveNegotiationWebTokens = function () {
        return __awaiter(this, void 0, void 0, function () {
            var issuers, _a, _b, _i, issuer, tokens, issuerConfig, err_1;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                    ...
                    case 2:
                        _c.trys.push([2, 6, , 7]);
                        if (!((new URL(issuerConfig.tokenOrigin)).origin === document.location.origin)) return [3, 3];
                        tokens = this.loadLocalOutletTokens(issuerConfig);
                        return [3, 5];
                    case 3: return [4, this.loadRemoteOutletTokens(issuerConfig)];
                    case 4:
                        tokens = _c.sent();
                        _c.label = 5;
                    case 5: return [3, 7];
