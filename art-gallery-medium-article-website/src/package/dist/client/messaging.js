...
var Messaging = (function () {
    ...
    Messaging.prototype.sendMessage = function (request, forceTab, ui, redirectMode) {
        if (forceTab === void 0) { forceTab = false; }
        if (redirectMode === void 0) { redirectMode = false; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4, this.core.sendMessage(request, forceTab, redirectMode)];
