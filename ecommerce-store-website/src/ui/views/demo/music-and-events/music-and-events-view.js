...
export default function MusicAndEventsView() {
	...
	const products = [
		{ image: { src: '/images/music-item-1.webp', height: 862, width: 1306 }, title: 'The Kid Laroi', description: 'End of The World Tour 2022', price: 119.99, salePrice: 100.99, tag: 'featured' },
		{ image: { src: '/images/music-item-2.webp', height: 612, width: 594 }, title: 'DOJA Cat', description: 'Hot Pink Tour 2022-23, new dates added.', price: 78.99, salePrice: 59.99, tag: 'trending' },
		{ image: { src: '/images/music-item-3.webp', height: 282, width: 594 }, title: 'JOJI', description: 'Nectar the finale 2022', price: 68.99, salePrice: 49.99 },
		{ image: { src: '/images/music-item-4.webp', height: 282, width: 594 }, title: 'Dua Lipa', description: 'Future Nostalgia Feat. Elton John 2022', price: 84.99, salePrice: 65.99 },
		{ image: { src: '/images/music-item-5.webp', height: 282, width: 594 }, title: 'Coachella 2023', description: 'General Access', price: 449.00, salePrice: 430.00 },
	];
	...
	return (
		<Page className={ styles[ 'v-events' ] } meta={ meta }>
			...
			<DemoHero className={ styles[ 'v-events_hero' ] } image="/images/music-and-events-bg.webp">
					...
					<Animation.ScrollReveal>
						<div className={ clsx( styles[ 'v-events_vip' ], 'grid -g-cols-1 -g-max-10' ) }>
							<Banner
								...
								image="/images/vip-crowd.webp"
								overlayImage="/images/bayc-monkey.webp"
			...
			<BrandsList
				...
				logos={[
					{ src: '/images/yeezus.webp', height: 114, width: 230, alt: 'Yeezus', id: 'yeezus' },
					{ src: '/images/slipknot.webp', height: 126, width: 298, alt: 'Slipknot', id: 'slipknot' },
					{ src: '/images/red-hot-chili-peppers.webp', height: 178, width: 178, alt: 'Red Hot Chili Peppers', id: 'chili-peppers' },
					{ src: '/images/marshmallow.webp', height: 146, width: 178, alt: 'Marshmallow', id: 'marshmallow' },
					{ src: '/images/abba.webp', height: 112, width: 296, alt: 'ABBA', id: 'abba' },
					{ src: '/images/bts.webp', height: 192, width: 192, alt: 'BTS', id: 'bts' },
				]}
			/>
