...
export default function Fashion() {
	...
	const products = [
		{ image: { src: '/images/fashion-item-1.webp', height: 686, width: 594 }, title: 'Statement - Lili Midi Dress', description: 'Dress like you do in your wildest dreams in the Lilly Midi Dress.', price: 119.99, salePrice: 79.99 },
		{ image: { src: '/images/fashion-item-2.webp', height: 686, width: 594 }, title: 'Real Vibes - Wrap Garden Dress', description: 'A gorgeous spring event dress, this Red Gardens Dress from Real Vibes is an event essential', price: 190.00, salePrice: 119.99 },
		{ image: { src: '/images/fashion-item-3.webp', height: 686, width: 594 }, title: 'Ask Judy - Coat', description: 'Beat the chill without sacrificing style is this Black wool blend detailed coat.', price: 139.99, salePrice: 89.99 },
		{ image: { src: '/images/fashion-item-4.webp', height: 686, width: 594 }, title: 'Lux Looks - Teal Dress', description: 'This teal modern design; delivers a simplified, well-made look for an audience who craves a relaxed coastal lifestyle.', price: 239.99, salePrice: 159.99 },
		{ image: { src: '/images/fashion-item-5.webp', height: 686, width: 594 }, title: 'Statement - Two-piece Outfit', description: 'This piece black outfit for a casual occasion or pair with heels for a more sophisticated look.', price: 179.00, salePrice: 109.99 },
	...
	return (
		<Page className={ styles[ 'v-fashion' ] } meta={ meta }>
			...
			<DemoHero className={ clsx( styles[ 'v-fashion_hero' ] ) } image="/images/fashion-bg.webp">
				<div className="grid -g-cols-3 -g-max-10">
					<div className="-g-cols-fill-2">
						<div className={ styles[ 'v-fashion_hero-logo' ] }>
							<Image src="/images/jimmy-choo-wow.webp" height={ 70 } width={ 658 } />
						</div>
					...
					<div className="-hide-s">
						<Image className={ styles[ 'v-fashion_hero-image' ] } src="/images/jimmy-choo-shoes.webp" width={ 756 } height={ 750 } alt="Jimmy Choo shoes" />
					</div>
				</div>
			</DemoHero>
			<ActivationBanner />
			...
			<BrandsList
				...
				headline="Brands"
				logos={[
					{ src: '/images/jimmy-choo.webp', height: 144, width: 144, alt: 'Jimmy Choo', id: 'jimmy-choo' },
					{ src: '/images/chanel.webp', height: 172, width: 230, alt: 'Chanel', id: 'chanel' },
					{ src: '/images/bvlgari.webp', height: 50, width: 312, alt: 'Bvlgari', id: 'bvlgari' },
					{ src: '/images/dg.webp', height: 92, width: 196, alt: 'Dolce & Gabbana', id: 'dolce' },
					{ src: '/images/prada.webp', height: 180, width: 236, alt: 'Prada', id: 'prada' },
					{ src: '/images/louis-vuitton.webp', height: 106, width: 432, alt: 'Louis Vuitton', id: 'louis-vuitton' },
				]}
			/>
