		...
		list: [
			{
				...
				imagePath: require('./nfts/stl-wow-4636.png'),
				name: "WoW #4636",
				id: "wow_4636",
				description: "stl demo nft"
			},
			{
				...
				ipfs: "https://gateway.pinata.cloud/ipfs/",
				imagePath: require('./nfts/stl-wow-9211.png'),
				name: "WoW #9211",
				id: "wow_9211",
				description: "stl demo nft"
			}
		...
		list: [
			{
				...
				imagePath: require('./nfts/stl-rr-airbender.png'),
				name: "STL Airbender",
				id: "air_bender",
				description: "stl demo nft"
			},
			{
				...
				imagePath: require('./nfts/stl-rr-aurora.png'),
				name: "STL Aurora",
				id: "air_aurora",
				description: "stl demo nft"
			}			
