...
var Client = (function () {
    ...
    Client.prototype.negotiatorConnectToWallet = function (walletType) {
        return __awaiter(this, void 0, void 0, function () {
            var Web3WalletProvider, walletAddress;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, import('./../utils/Web3WalletProvider')];
                    case 1:
                        Web3WalletProvider = (_a.sent()).default;
                        this.web3WalletProvider = new Web3WalletProvider();
                        return [4, this.web3WalletProvider.connectWith(walletType)];
                    case 2:
