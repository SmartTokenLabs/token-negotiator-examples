        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2, new Promise(function (resolve, reject) {
                        try {
                            var walletConnectProvider_1 = new WalletConnectProvider({
                                infuraId: "7753fa7b79d2469f97c156780fce37ac",
                            });
                            walletConnectProvider_1.on("accountsChanged", function (accounts) {
                                logger(2, accounts);
                                var registeredWalletAddress = _this.registerNewWalletAddress(accounts[0], '1', walletConnectProvider_1);
                                resolve(registeredWalletAddress);
                            });
                            walletConnectProvider_1.on("chainChanged", function (chainId) {
                                logger(2, chainId);
                            });
                            walletConnectProvider_1.on("disconnect", function (code, reason) {
                                logger(2, code, reason);
                            });
                            walletConnectProvider_1.enable().catch(function (e) {
                                reject(e);
                            });
                        }
                        catch (e) {
