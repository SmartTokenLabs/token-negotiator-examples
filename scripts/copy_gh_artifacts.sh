...
# Vue Js example 1
cp -R vue-boilerplate/build build/vue-boilerplate

# Vue Js example 2 (VITE + UMD)
cp -R vue-vite-boilerplate/build build/vue-vite-boilerplate

# Angular example
cp -R angular-bare-bones-demo/build build/angular-bare-bones-demo
